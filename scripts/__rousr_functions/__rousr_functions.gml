	...
	if (draw_all) {
	  draw_clear_alpha(c_black, 0);
		...
		for (var i = 0; i < num_sprites; ++i) {
			...
			if(sprite_exists(spr)) draw_sprite(spr, img, r_min[0] + sprite_get_xoffset(spr), r_min[1] + sprite_get_yoffset(spr));	
		}
	} else {
...
///@function sr_sprite_cache_create([_width=4096], [_height=4096])
///@desc create a new sprite cache
///@param {Real} [_width=4096]
///@param {Real} [_height=4096]
